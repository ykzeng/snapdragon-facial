...
public class GalleryProcessing extends Activity {
	...
	private int MY_PERMISSIONS_READ_STORAGE = -1;
	...
	public void requestReadStoragePermissions(){
		int permissionFlag = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE);
		if (permissionFlag != PackageManager.PERMISSION_GRANTED){
			ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, MY_PERMISSIONS_READ_STORAGE);
		}
	}
